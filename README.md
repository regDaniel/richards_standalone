# Richards Standalone: Standalone solver for Richards' equation.
...
pytest
```
. If the tests pass, you are good to go. If not, contact the package administrator Daniel Regenass. Make sure to update your requirement files and export your environments after installation
